		...
		<div class="wrapper">
			...
			<!-- MAIN COLUMN -->
				<div class="card text-center">
					...
					<p>
						I am a 20 year old university student who has a fondness for programming and mathematics. This dual fates of interest leads me to my current pursuit for a computer science degree. I was born in Singapore but lived in Malaysia for most of my life. I'm half Austrian but I've chosen to study in the UK in order to improve my englsh lmao. I am a dedicated student who's looking for exciting opportunities to expand my domain of knowledge in the techn industry. I've had experience working in teams during my 5 day sailing trip for the Gold Duke of Edinburgh award and I've managed and run my own business team for my Junior Achievement challenge.
					</p>
					</div>
				...
				<div class="card" style="margin-bottom: 5em;">
					<div class="card-header">
						...
						<ul class="list-group list-group-flush">
							...
							<li class="list-group-item">2016-2018 - Junior Achievement Programme</li>
						</ul>
				</div>
